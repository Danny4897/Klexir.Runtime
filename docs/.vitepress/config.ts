...
export default defineConfig({
  title: 'Klexir.Runtime',
  description: 'Experimental bytecode runtime for Klexir',
  base: '/Klexir.Runtime/',
  cleanUrls: true,
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Klexir.Runtime' }],
    ['meta', { property: 'og:description', content: 'Experimental bytecode runtime for Klexir' }],
  ],

  themeConfig: {
    siteTitle: 'Klexir.Runtime',
    ...
    nav: [
      ...
      { text: 'GitHub', link: 'https://github.com/Danny4897/Klexir.Runtime' },
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Danny4897/Klexir.Runtime' },
    ],
